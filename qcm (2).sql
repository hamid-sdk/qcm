...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 13 mai 2024 à 19:53
...
INSERT INTO `historique` (`id_hist`, `id_users`, `note`, `date`, `niveau`) VALUES
(2, 1, '10', '2024-05-01 15:52:46', 'difficile'),
(3, 1, '6', '2024-05-01 16:02:05', 'facile'),
(42, 3, '10', '2024-05-13 19:51:57', 'difficile'),
(41, 3, '8', '2024-05-03 08:36:36', 'difficile');
...
(40, 'Quelle est la reponse a la vie ????', 1),
(41, 'C\'est qui le plus intelligent', 0),
(43, 'Comment je m\'appelle?', 1);
...
(6, 2, 'Une  venant du champs du voisin', 0),
(5, 2, 'Une  venant du champs du voisin', 0),
(4, 1, 'Je ne sais pas', 0),
(2, 1, 'Non', 1),
(3, 1, 'Peut-etre', 0),
(1, 1, 'Oui', 0),
(7, 2, 'Une  venant du champs du voisin', 1),
(8, 2, 'Une  venant du champs du voisin', 0),
(9, 3, 'Bleue', 1),
(10, 3, 'Rouge', 0),
(11, 3, 'Jaune', 0),
(12, 3, 'Vert', 0),
...
INSERT INTO `users` (`id_users`, `nom`, `prenom`, `mail`, `tel`, `mdp`) VALUES
(1, 'adenle', 'hamid', 'hamid@gmail.com', '06278639', 'hamid'),
(2, 'sadikou', 'hamid', 'sadikou@gmail.com', '08765467', 'sadikou'),
(3, 'adenle', 'adenle', 'adenle@gmail.com', '34567890987654', 'adenle');
COMMIT;
